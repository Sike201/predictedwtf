...
import {
  simulatePreviewLeverageNoFromUsdc,
...
type Body = {
  ...
  slippageBps?: number;
  /** When true, skips wallet USDC balance check (feasibility probes only). */
  ...
  try {
    ...
    const slippageBps =
      typeof body.slippageBps === "number" && Number.isFinite(body.slippageBps)
        ...
        : 150;
    const skipUsdcBalanceCheck = body.skipUsdcBalanceCheck === true;
    ...
    if (sideRaw === "yes") {
      ...
      return NextResponse.json({
        ...
        preview: {
          ...
          estimatedYesOutAtoms: preview.estimatedYesOutAtoms.toString(),
          minYesOutAtoms: preview.minYesOutAtoms.toString(),
          noAta: preview.noAta.toBase58(),
          yesAta: preview.yesAta.toBase58(),
        },
      });
    }
    ...
    return NextResponse.json({
      ...
      preview: {
        ...
        estimatedNoOutAtoms: preview.estimatedNoOutAtoms.toString(),
        minNoOutAtoms: preview.minNoOutAtoms.toString(),
        noAta: preview.noAta.toBase58(),
        yesAta: preview.yesAta.toBase58(),
      },
    });
